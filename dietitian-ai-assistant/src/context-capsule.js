export function buildClientContextCapsule({
  ...
  return {
    ...
    client: {
      ...
      menuPlanRevision: client.menuPlanRevision ?? null,
      menuPlanUpdatedAt: client.menuPlanUpdatedAt ?? null,
      foodRuleRevision: client.foodRuleRevision ?? null,
      foodRuleUpdatedAt: client.foodRuleUpdatedAt ?? null,
      formRevision: client.formRevision ?? null,
      formUpdatedAt: client.formUpdatedAt ?? null,
      dietPlanRevision: client.dietPlanRevision ?? null,
      dietPlanUpdatedAt: client.dietPlanUpdatedAt ?? null,
