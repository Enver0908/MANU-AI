...
1. Unblock completion roadmap Phase 2 by starting Docker Desktop/local Supabase, rerunning the expanded 11-test `npm run test:rls` suite, and updating R-406/evidence docs only if the suite passes.
