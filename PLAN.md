...
1. Implement official regulation PDF ingestion in Phase 71 only after the user supplies official PDFs.
2. Build regulation permission graph and calibration in Phase 72-73 after legal/clinical inputs.
