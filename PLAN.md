...
1. Execute Scale / Broad Read Contracts: classify broad full-state reads, document which remain intentionally tenant-wide, and define pagination/filter contracts for future dashboard/admin/export scale work.
