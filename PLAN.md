...
4. Keep Phase 23-39 prompt-context, voice-profile, dynamic-form, internal-copilot, dietitian context update, provider-boundary, channel-policy, incident/DSAR, backup/restore, send-revalidation, evidence, dependency, external-approval, legal/privacy, clinical-taxonomy, provider/vendor, and RLS controls covered by tests before any real provider or channel integration.
