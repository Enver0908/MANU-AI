...
4. Keep Phase 23-35 prompt-context, voice-profile, dynamic-form, internal-copilot, dietitian context update, provider-boundary, send-revalidation, evidence, dependency, external-approval, legal/privacy, clinical-taxonomy, and RLS controls covered by tests before any real provider integration.
