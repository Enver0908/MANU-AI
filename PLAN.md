...
Current continuity status, 2026-08-28: Stage 6 is locally closed with an explicit iPhone validation waiver, and the owner has now made that iPhone waiver permanent for this roadmap and future phases; Stage 5 is closed locally; physical-device, RLS, dependency, shell, and closure evidence pass for their recorded scopes. R-405 is technically resolved locally. Production remains `NO-GO` under its independent external and operational gates.
