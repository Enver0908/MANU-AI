...
1. Complete remaining production gates (WhatsApp, ops, R-405 closure, full 100x50 rehearsal, external launch-gate closure).
...
4. Complete WhatsApp adapter, production ops, R-405 closure, full 100x50 rehearsal, and external launch-gate closure before direct production GO.
