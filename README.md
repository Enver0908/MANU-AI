...
**Current authority (2026-08-24):** Stage 6 Dashboard Core Workflows is locally `STAGE_6_CLOSED`. Physical Android Chrome/PWA evidence passed; the owner explicitly accepted the absence of new Stage 6 physical iPhone Safari/PWA evidence, which is recorded as `WAIVED_NOT_EXECUTED` and not PASS. Stage 7.1 through Stage 7.4 are superseded for Stage 7 closure. Stage 7R.0 and Stage 7R.1 are complete locally; Stage 7R.2 trusted baseline is recorded and awaits user visual approval. Stage 7 is not closed, Stage 7.5 is not started, and Stage 7R.3 must not start before visual approval or a user-directed adjustment. Stage 5 remains `STAGE_5_CLOSED`; production remains `NO-GO`. Stage 7R authority: `docs/PHASE_85_STAGE_7R_SUPERSESSION_DECISION.json`; finding lock: `docs/PHASE_85_STAGE_7R_FINDING_LOCK.json`.
