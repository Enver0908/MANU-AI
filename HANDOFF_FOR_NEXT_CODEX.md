...
**Current plan-implementation assurance integration (2026-08-24):** Phase 0 is committed as `6318fca`. Canonical plan: `docs/execution-governance/MANU_AI_PLAN_IMPLEMENTATION_ASSURANCE_INTEGRATION_PLAN.md`; Phase 0 evidence: `docs/execution-governance/PHASE_0_AUTHORITY_AND_BASELINE_LOCK_EVIDENCE.md`. Phase 1 is implemented-unverified locally and creates the portable protocol, status model, JSON schemas, and templates. Independent review remains optional and starts only when the user explicitly requests it.
