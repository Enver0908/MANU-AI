...
**Latest governance Phase 1 status (2026-08-24):** Core protocol and status model are implemented-unverified locally. New authority protocol: `docs/execution-governance/EXECUTION_ASSURANCE_PROTOCOL.md`; schemas/templates: `.execution-governance/`. Phase 1 intentionally does not install verifier CLI, Cursor hooks, root `AGENTS.md`, GitHub Actions, or product runtime changes. Next governance step after Phase 1 commit is Phase 2: deterministic verifier CLI.
