...
**Current public surface/auth/onboarding/PWA planning status (2026-09-04):** Faz 8 reclosure is in progress. Canonical plan: `docs/PUBLIC_SURFACE_AUTH_ONBOARDING_PWA_ACTION_PLAN.md`. Requirement matrix: `docs/PUBLIC_SURFACE_AUTH_ONBOARDING_PWA_REQUIREMENT_MATRIX.md`. Phase 0–7 historical PASS verdicts are superseded until Faz 8 closes with zero-skip local RLS and physical Android Chrome/A2HS/TalkBack evidence. Production remains `NO-GO`. iPhone Safari/PWA remains `WAIVED_NOT_EXECUTED`. Live VPS release remains `4c7bbea8ba21fb84b51843eac9fff2e9ff8fecf9`.
