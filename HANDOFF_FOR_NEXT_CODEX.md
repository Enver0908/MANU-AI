...
6z. `docs/PHASE_85_INTERSTAGE_TRUSTED_CLINICAL_COMMUNICATION_MEMORY_PLAN.md` and `docs/PHASE_85_INTERSTAGE_TRUSTED_CLINICAL_COMMUNICATION_MEMORY_SPEC.md` (canonical P85-IF plan plus P85-IF-A contract and P85-IF-B data model foundation; P85-IF-C next)
