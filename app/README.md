...
**Current public surface/auth/onboarding/PWA local closure (2026-09-04):** Faz 8 reclosure is in progress. Canonical plan: `../docs/PUBLIC_SURFACE_AUTH_ONBOARDING_PWA_ACTION_PLAN.md`. Production remains `NO-GO`.
