...
**Current public surface/auth/onboarding/PWA local closure (2026-09-07):** Faz 8 clean-HEAD reclosure is locally complete. Canonical plan: `../docs/PUBLIC_SURFACE_AUTH_ONBOARDING_PWA_ACTION_PLAN.md`; evidence: `../docs/PUBLIC_SURFACE_AUTH_ONBOARDING_PWA_PHASE_8_CLEAN_HEAD_EVIDENCE.md`. Production remains `NO-GO`.
