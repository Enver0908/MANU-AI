...
export function serializeChannelDeliveryForExport(record: ChannelDeliveryRecord) {
  return {
    ...
    realProviderMessageId: record.realProviderMessageId ?? null,
    executionState: record.executionState ?? record.deliveryStatus,
    retryCount: record.retryCount ?? 0,
    nextRetryAt: record.nextRetryAt ?? null,
    providerErrorCategory: record.providerErrorCategory ?? null,
