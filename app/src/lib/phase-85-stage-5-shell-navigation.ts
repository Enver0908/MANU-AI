...
const DESTINATION_META: Record<ShellDestinationId, DestinationMeta> = {
  ...
  clients: {
    ...
    fallbackLabel: "Danışanlar",
    fallbackShortLabel: "Danışan",
    icon: UsersRound,
  },
  messages: {
    navKey: "messages",
  ...
  alerts: {
    ...
    fallbackLabel: "Uyarılar",
    fallbackShortLabel: "Uyarı",
    icon: AlertTriangle,
  },
  notifications: {
