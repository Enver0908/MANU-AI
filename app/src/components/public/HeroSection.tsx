      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6">
        <div className="mx-auto flex max-w-xl flex-col items-center gap-4 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            <Link
              href="/login"
              className="inline-flex min-h-11 items-center justify-center rounded-md border border-border bg-surface px-5 text-sm font-semibold text-foreground transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
            >
              Giriş yap
            </Link>
          </div>
          ...
          <p className="text-xs text-muted-foreground">
            Henüz müşteri değilseniz iletişim formu ile bize ulaşın.
          </p>
