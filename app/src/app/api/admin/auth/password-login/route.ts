...
export async function POST(request: NextRequest) {
  ...
  let body: AdminPasswordLoginBody;
  try {
    body = (await request.json()) as AdminPasswordLoginBody;
  } catch {
  ...
  return applyAuthMutations(NextResponse.json({ authenticated: true, next: "/admin" }));
}
