...
const runnerPath = join(scriptDir, "..", "src", "lib", "phase-85-stage-4b4-durable-admission-worker-cli.ts");
...
const result = spawnSync(
  ...
  ["--experimental-strip-types", runnerPath, ...forwardedArgs],
  {
    ...
    env: {
      ...process.env,
      MANU_STAGE4B4_ADMISSION_WORKER_INTERVAL_MS: String(intervalMs),
    },
    shell: false,
  },
);
