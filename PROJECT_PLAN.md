...
**Current authority (2026-08-24):** Stage 6 Dashboard Core Workflows is locally `STAGE_6_CLOSED`. Android Chrome/PWA physical evidence passed and final `release:verify` passed. Physical iPhone Safari/PWA was not executed and is explicitly recorded as `WAIVED_NOT_EXECUTED`; this accepted risk cannot support an iOS production pilot/readiness claim. Stage 7.1 through Stage 7.4 are superseded for Stage 7 closure. Stage 7R.0 through Stage 7R.4 are complete locally; Stage 7R.5 hard gate and evidence reclosure is implemented and validated with `audit:stage-7`, `test:stage-7-lab-perf`, and `verify:stage-7:7.4` PASS, but Stage 7.5 final closure supersedes that pending-status wording. Stage 7 is locally STAGE_7_CLOSED. Stage 5 remains closed; production remains `NO-GO`. Stage 7R authority: `docs/PHASE_85_STAGE_7R_SUPERSESSION_DECISION.json`; finding lock: `docs/PHASE_85_STAGE_7R_FINDING_LOCK.json`.
