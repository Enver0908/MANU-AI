...
Phase 85 Stage 4A client control panel update, 2026-07-08: DCP-1 through DCP-4 are implemented (client form, active nutrition plan, menu workflow/export, AI assistant control). Stage 4A is complete. No backend API, auth, entitlement, billing, provider/channel, PWA, or production-path changes were made in DCP-1..4. Production pilot remains `NO-GO`; R-405 open; R-406 current local Supabase/RLS re-run pending.
