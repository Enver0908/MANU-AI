...
**Governance Phase 6 (2026-08-24):** Red-team, pilot, and documentation closure is implemented-unverified locally. The new red-team harness is included in the read-only workflow and validates synthetic anti-gaming scenarios for hooks, scope, shell-wrapper command specs, plan tamper, stale artifacts, forbidden diffs, skip/only markers, no-review close, review-scope boundaries, workflow hardening, and runtime artifact tracking. Product runtime, dependencies, migrations, production gates, branch protection, default branch, push, deploy, and Stage 7 closure are unchanged.
