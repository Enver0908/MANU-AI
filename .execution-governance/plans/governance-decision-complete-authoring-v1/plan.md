...
## Phase GOV-DCPA-1 Out Of Scope
<!-- GOV-SECTION id="out-of-scope" -->

- Product runtime files, Supabase migrations, production deployment, live external services, Stage closure claims, and iPhone PASS claims remain excluded from this phase.
