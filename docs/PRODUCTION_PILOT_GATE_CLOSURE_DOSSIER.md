...
- Latest local release verification: `npm run release:verify` passed on 2026-06-01 after Phase 44 red-risk reactivation lock.
- Verification result: core tests 52/52, app tests 112/112, lint passed, production build passed.
