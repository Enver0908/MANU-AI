...
**Current authority (2026-08-24):** Stage 6 is locally `STAGE_6_CLOSED`. Android Chrome/PWA physical evidence and final `release:verify` passed. New physical iPhone Safari/PWA evidence was explicitly waived as `WAIVED_NOT_EXECUTED`; it is not a PASS and must be completed before any iOS production pilot/readiness claim. Stage 7.1 through Stage 7.4 are superseded for Stage 7 closure. Stage 7R.0 through Stage 7R.2 are complete locally; Stage 7R.3 shared/public/commercial remediation is implemented and validated with `verify:stage-7:7.2` PASS, but visual review/commit approval is pending. Stage 7 is not closed, Stage 7.5 is not started, and Stage 7R.4 is not started. Stage 5 remains closed and production remains `NO-GO`. Authority: `docs/PHASE_85_STAGE_7R_SUPERSESSION_DECISION.json`; finding lock: `docs/PHASE_85_STAGE_7R_FINDING_LOCK.json`.
