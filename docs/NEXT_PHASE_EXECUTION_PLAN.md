...
**Current authority (2026-08-20):** Stage 6 accessibility remediation and its desktop/Android-mobile axe rerun pass, closing `S6-P4-A11Y`. The next and only Stage 6 closure unit is new post-remediation physical iPhone Safari/PWA and Android Chrome/PWA workflow evidence, followed by final `release:verify` and closure reconciliation. Stage 6 remains open, Stage 5 remains closed, and production remains `NO-GO`. Evidence: `docs/PHASE_85_STAGE_6_ACCESSIBILITY_REMEDIATION_EVIDENCE.md`.
